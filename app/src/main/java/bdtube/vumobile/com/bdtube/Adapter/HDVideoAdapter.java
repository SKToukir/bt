...
/**
 * Created by toukirul on 3/10/2017.
 */
...
public class HDVideoAdapter extends RecyclerView.Adapter<HDVideoAdapter.MyViewHolder> {
    ...
    private List<HDVideo> videoHomeList;

    public HDVideoAdapter(Context context, List<HDVideo> videoHomeList){
    ...
    public HDVideoAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_hd_video,parent,false);
    ...
    public void onBindViewHolder(HDVideoAdapter.MyViewHolder holder, int position) {
        ...
        HDVideo primaryClass = videoHomeList.get(position);
