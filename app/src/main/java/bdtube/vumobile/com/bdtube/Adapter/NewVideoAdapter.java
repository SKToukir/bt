...
public class NewVideoAdapter extends RecyclerView.Adapter<NewVideoAdapter.MyViewHolder> {


    //ImageLoader imageLoader =  AppController.getInstance().getImageLoader();;
    private Context mContext;
    private List<NewVideo> videoHomeList;

    public NewVideoAdapter(Context context, List<NewVideo> videoHomeList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        final NewVideo primaryClass = videoHomeList.get(position);
