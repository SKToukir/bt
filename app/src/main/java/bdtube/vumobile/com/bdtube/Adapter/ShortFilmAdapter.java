...
public class ShortFilmAdapter extends RecyclerView.Adapter<ShortFilmAdapter.MyViewHolder> {
    ...
    private List<ShortFilmClass> videoHomeList;

    public ShortFilmAdapter(Context context, List<ShortFilmClass> videoHomeList){
    ...
    public void onBindViewHolder(ShortFilmAdapter.MyViewHolder holder, int position) {
        ...
        ShortFilmClass primaryClass = videoHomeList.get(position);
