...
import bdtube.vumobile.com.bdtube.Model.HollywoodGossipClass;
...
public class HollywoodGossipAdapter extends RecyclerView.Adapter<HollywoodGossipAdapter.MyViewHolder> {
    ...
    private List<HollywoodGossipClass> videoHomeList;

    public HollywoodGossipAdapter(Context context, List<HollywoodGossipClass> videoHomeList){
        this.mContext = context;
        this.videoHomeList = videoHomeList;
    }

    @Override
    public HollywoodGossipAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_video,parent,false);

        return new HollywoodGossipAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(HollywoodGossipAdapter.MyViewHolder holder, int position) {

        HollywoodGossipClass primaryClass = videoHomeList.get(position);
